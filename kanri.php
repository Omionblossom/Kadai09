...
//２．データ取得SQL作成
$stmt = $pdo->prepare("SELECT * FROM gs_user_table WHERE kanri_flg = 1;");
$status = $stmt->execute();
...
<body>
<div class="excel" >
<a class="icon_l">Control Panels</a>
    <a class="icon_r2" href="./kanri.php">User Management</a><br><br>
    ...
    <table border="1">
    <tr class="header">
    <th class="item2">User name</th>
          <th class="item2">ID</th>
          <th class="item2" >Delete user</th>
</tr>
    <div><?= $view ?></div>
    </table>
    </form>
